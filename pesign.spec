...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664917554
...
cp %{_builddir}/pesign-%{version}/COPYING %{buildroot}/usr/share/package-licenses/pesign/842745cb706f8f2126506f544492f7a80dbe29b3 || :
%make_install
